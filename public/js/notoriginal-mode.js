// ============================================================
// REFLEXRHYTHM — NOT ORIGINAL MODE (N.O.M ENGINE)
...
function nomGameOver() {
  ...
  if (popup) {
    const track =
      typeof NOM_TRACKS !== "undefined" ? NOM_TRACKS[finalTrackIdx] : null;
    const clicks =
      typeof profile !== "undefined" && profile.stats?.notoriginal
